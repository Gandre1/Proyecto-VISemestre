...
class FormularioDesarrollo extends Component {
  constructor(props) {
    super(props);
    this.state = {
      dia: '',
  ...
  render() {
    ...
    return (
      <div className="container formulario-container">
        ...
        <div className="mt-3">
          <Link to="/inicio" className="btn btn-secondary mr-2">Volver</Link>
          <Link to="/finalizacion" className="btn btn-primary">Siguiente</Link>
        </div>
      </div>
    );
  }
